...
@WebServlet("/admin/writer/details")
public class GetWriterDetailsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, DatabaseOperationException {
        ...
        adminService.getWriterDetails(writerId);
        response.getWriter().write(CommonUtils.getGson().toJson(adminService.getWriterDetails(writerId)));
    }
}
