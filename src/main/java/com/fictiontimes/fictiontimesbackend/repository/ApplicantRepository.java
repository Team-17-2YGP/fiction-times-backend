...
public class ApplicantRepository {
    ...
    public WriterApplicant getWriterApplicantById(int userId) throws SQLException, IOException, ClassNotFoundException {
    ...
    public void updateRequestedAt(WriterApplicant applicant) throws SQLException, IOException, ClassNotFoundException {
        statement = DBConnection.getConnection().prepareStatement(
