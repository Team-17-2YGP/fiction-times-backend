...
public class WriterRepository {
    ...
    public Writer findWriterById(int writerId) throws SQLException, IOException, ClassNotFoundException {
    ...
    public int getFollowerCountById(int writerId) throws SQLException, IOException, ClassNotFoundException {
        statement = DBConnection.getConnection().prepareStatement(
    ...
    public int getStoryCountById(int writerId) throws SQLException, IOException, ClassNotFoundException {
        statement = DBConnection.getConnection().prepareStatement(
